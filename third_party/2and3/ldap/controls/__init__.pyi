...
class RequestControl:
    ...
    def __init__(
        self, controlType: Optional[Any] = ..., criticality: bool = ..., encodedControlValue: Optional[Any] = ...
    ) -> None: ...
...
class LDAPControl(RequestControl, ResponseControl):
    ...
    def __init__(
        self,
        controlType: Optional[Any] = ...,
        criticality: bool = ...,
        controlValue: Optional[Any] = ...,
        encodedControlValue: Optional[Any] = ...,
    ) -> None: ...
